...
class LoginMixin(PreLoginFlowMixin, PostLoginFlowMixin):
    ...
    def _sessionid_user_fallback(self, user_id: str) -> UserShort:
        try:
            return self._user_short_from_private_stream(user_id)
        except (ClientError, ValidationError, KeyError, TypeError, AttributeError):
            return self.user_short_gql(int(user_id))
    ...
    def login_by_sessionid(self, sessionid: str) -> bool:
        ...
        try:
            ...
            user = self._sessionid_user_fallback(user_id)
